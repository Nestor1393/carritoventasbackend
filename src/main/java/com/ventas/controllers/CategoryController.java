...
public class CategoryController {
    ...
    public String registrarCategoria(Model model, HttpServletRequest request){
        ...
        if(categoriaGuardada != null){
            ...
            model.addAttribute("success", "La categoria se registró correctamente");
        }else{
            model.addAttribute("success", "La categoria no pudo ser registrado");
        }
